...
import { getAllDocs, searchDocs, getCategories, getDocsByCategory } from "@/data/documentation";
import Link from "next/link";

export const metadata = {
  title: "GigThink Documentation | Product Help & Guides",
  description: "Learn how to use GigThink with our step-by-step documentation, guides, and product references.",
};
...
export default async function DocsHomePage({
  ...
  // Group displayed docs by category for nice presentation
    ...
    <div>
      <div className="mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
          Everything you need to understand, configure, and get the most out of GigThink.
        </p>
        <DocsSearch />
      </div>
      ...
      {query ? (
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-heading font-semibold text-headings mb-4">Popular Topics</h2>
