...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      // Calling custom API that checks for Temp Mail and creates user
      ...
      // Success Message with Spam Folder Warning
      setMessage(
        "Account successfully created! 🎉 Please check your email inbox to verify. (Note: Check your Spam/Junk folder if not found)."
      );
